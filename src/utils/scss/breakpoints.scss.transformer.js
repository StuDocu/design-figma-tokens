...
module.exports = {};
module.exports.breakpointsVariablesTransformer = function breakpointsVariablesTransformer(props) {
...
module.exports.breakpointsMixinsTransformer = function breakpointsMixinsTransformer(props) {
    const { Breakpoints } = props.dictionary.properties;
