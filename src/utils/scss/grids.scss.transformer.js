...
module.exports = {};
module.exports.gridsVariablesTransformer = function gridsVariablesTransformer(props) {
    ...
    const exceptions = Object.entries(Grid.exceptions).reduce((output, [key, gridValue]) => {
        return [
            ...output,
