...
const { generateAllMixinsFile, generateAllVariablesFile } = require('./utils/scss/all.scss.generator');
const {
...
const { gridsMixinsTransformer, gridsVariablesTransformer } = require('./utils/scss/grids.scss.transformer');
